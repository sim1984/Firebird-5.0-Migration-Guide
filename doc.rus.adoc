...
- если ничего из выше перечисленного не помогло, то создайте билет о регрессии по адресу https://github.com/FirebirdSQL/firebird/issues[https://github.com/FirebirdSQL/firebird/issues].
